...
local function UnitSpawner()
	...
	if campaignBattleID == 1 then
		local unitOne = Spring.CreateUnit("euf_marine", x-45, y, z+70, 0, teamID)
		local unitTwo = Spring.CreateUnit("euf_marine", x-15, y, z+85, 0, teamID)
		local unitThr = Spring.CreateUnit("euf_marine_laser", x+15, y, z+85, 0, teamID)
		local unitFou = Spring.CreateUnit("euf_sniper", x+45, y, z+70, 0, teamID)
	elseif campaignBattleID == 3 then
		local unitOne = Spring.CreateUnit("euf_pyro_mis", x-50, y, z-40, 0, teamID)
		local unitTwo = Spring.CreateUnit("euf_pyro_mis", x-50, y, z+60, 0, teamID)
--		local unitThr = Spring.CreateUnit("euf_pyro_mis", x, y, z-50, 0, teamID)
--		local unitFou = Spring.CreateUnit("euf_pyro_mis", x-10, y, z+50, 0, teamID)
		local unitFiv = Spring.CreateUnit("euf_pyro_mis", x+50, y, z-50, 0, teamID)
		local unitSix = Spring.CreateUnit("euf_pyro_mis", x+55, y, z+55, 0, teamID)
